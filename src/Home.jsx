...
const Home = () => {
  ...
  const currentCard = filteredData.slice(indexOfFirstCard, indexOfLastCard);
  const totalPages = Math.ceil(filteredData.length / cardsPerPage);
  const paginate = pageNumber => setCurrentPage(pageNumber);

  useEffect(() => {
    axios
      .get("https://library-management-system-backend-qg3f.onrender.com/")
